...
#### H3:
Sensory experiences are (on average) for some modalities easier (more vividly) imagined or simulated mentally compared to other modalities, i.e. we hypothesize that visual experiences are easier to mentally imagine than imagining experiences by the other six modalities:
H3: On average mental images evoked by visual experiences have higher vividness-ratings than those evoked by the other six modalities.



If one looks at the ouput plot of the marginal effects$type:language_eq:
...
#### H4:
Sensory experiences are (on average) harder (less vividly) imagined or simulated mentally for some modalities compared to other modalities, i.e. we hypothesize that olfactory and gustatory experiences are harder to imagine than the five other modalities: 
H4: On average mental images evoked by olfactory or gustatory experiences have lower vividness-ratings than those evoked by the other five modalities
